...
export async function performResearch(websiteUrl, apiKey) {
    try {
...
export async function generateSequence(firma, websiteUrl, imie, researchResult, apiKey, customSignature) {
